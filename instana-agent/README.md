...
| `leaderElector.limits.cpu`                          | Container cpu limits in cpu cores                                                                                                                                                                                                                                                                                      | `100mi`                                                                                                                                 |
| `leaderElector.limits.memory`                       | Container memory limits in MiB                                                                                                                                                                                                                                                                                         | `64Mi`                                                                                                                                  |
| `leaderElector.requests.cpu`                        | Container cpu requests in cpu cores                                                                                                                                                                                                                                                                                    | `100mi`                                                                                                                                 |
| `leaderElector.requests.memory`                     | Container memory requests in MiB                                                                                                                                                                                                                                                                                       | `64Mi`                                                                                                                                  |
...
* Allow configuring resource quotas of leader elector container
