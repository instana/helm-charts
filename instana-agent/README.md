...
| `agent.instanaMvnRepoFeaturesPath`      | Set value for INSTANA_MVN_REPOSITORY_FEATURES_PATH environment when specifying a locally provided Maven repository 'proxy' for the Agent                                                                                              | `nil` Usually not required |
| `agent.instanaMvnRepoSharedPath`        | Set value for INSTANA_MVN_REPOSITORY_SHARED_PATH environment when specifying a locally provided Maven repository 'proxy' for the Agent                                                                                                                                 | `nil` Usually not required |
