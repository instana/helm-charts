...
| `leaderElector.resources.requests.cpu`              | CPU requests for the `leader-elector` containers in the instana-agent pods                                                                                                                                                                                                                              | `0.1`                                                                                                                                                  |
| `leaderElector.resources.requests.memory`           | Memory requests for the `leader-elector` containers in the instana-agent pods                                                                                                                                                                                                                           | `64Mi`                                                                                                                                                 |
| `leaderElector.resources.limits.cpu`                | CPU limits for the `leader-elector` containers in the instana-agent pods                                                                                                                                                                                                                                | `0.2`                                                                                                                                                  |
| `leaderElector.resources.limits.memory`             | Memory limits for the `leader-elector` containers in the instana-agent pods                                                                                                                                                                                                                             | `128Mi`                                                                                                                                                |
...
### 1.2.59
* Adds resource limits to leader-elector containers. 
* Allows to set resource requests and limits for leader-elector containers via `leaderElector.resources.requests.cpu`,`leaderElector.resources.requests.memory`, `leaderElector.resources.limits.cpu` and `leaderElector.resources.limits.memory`
